            ...
            <div class="login__form">
                <form action="./index.php?controle=utilisateur&action=ident" method="post" class="login__register" id="login-in">
                    ...
                    <div class="login__box">
                        ...
                        <input type="text" name="ident" value="<?php echo $ident; ?>" placeholder="Identifiant" class="login__input">
                    </div>
                    <div class="login__box">
                    ...
                    <!-- SIGN UP -->
                    <div>
                        <span class="login__account">Vous ne possedez pas de compte?</span>
                        <a href="./index.php?controle=utilisateur&action=inscr" class="login__signin">Inscrivez-vous</a>
                    </div>
                </form>
            </div>
        </div>
